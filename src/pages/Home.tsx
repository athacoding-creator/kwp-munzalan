          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 animate-fade-in">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-6 leading-tight text-gray-900">
                ...
                <br />
                <span className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-700">YOGYAKARTA</span>
              </h1>
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    {program.deskripsi && (
                      <p className="text-sm text-muted-foreground leading-relaxed line-clamp-2">{program.deskripsi}</p>
                    )}
                  </CardContent>
                </Card>
              );
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch max-w-6xl mx-auto">
            ...
            <Card className="border-0 shadow-elegant overflow-hidden animate-fade-in delay-200 flex flex-col h-full">
              ...
              <CardContent className="p-6 space-y-4 flex-1 flex flex-col justify-center">
                {["Menghadirkan semangat kebersamaan, kepedulian, kasih sayang untuk memuliakan, melayani, membahagiakan sahabat yatim, penghafal Al-Qur'an, mustahiq dan fii sabilillah agar semakin dekat dengan Allah dan Rasul-Nya.", "Melaksanakan gerakan dakwah bil hal dengan mengkampanyekan seruan \"Jangan Bosan Jadi Orang Baik\" dengan metode kreatif, inovatif dan edukatif.", "Membentuk, mendidik dan memberdayakan santri PASKAS (Pasukan Amal Sholeh) sebagai jembatan amal sholeh yang mempertemukan orang baik dengan orang perlu.", "Dengan terbentuknya santri PASKAS, BMI menjalankan fungsinya sebagai jembatan amal sholeh dan melakukan prinsip dasar dalam proses pendistribusian yaitu konsep \"Terima Kasih\" yaitu mengantarkan amanah terbaik dari orang baik untuk orang baik.", "Bersama-sama berusaha, berdoa untuk terwujudnya kemandirian, kesejahteraan, kepedulian orang-orang baik (Muzakki, Munfiq, Wakif) dan penerima manfaat (sahabat yatim, penghafal Qur'an, mustahiq dan fii sabilillah) melalui program ZISWAF agar semakin dekat dan taat kepada Allah dan Rasul-Nya"].map((misi, index) => <div key={index} className="flex gap-3">
